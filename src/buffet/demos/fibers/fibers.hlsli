...
FB_CONSTANT uint SIM_DISPATCH_X = 32;
FB_CONSTANT uint SIM_DISPATCH_Y = 1;
FB_CONSTANT uint SIM_DISPATCH_Z = 1;
FB_CONSTANT uint CULL_TILE_SIZE = 16;
FB_CONSTANT uint CULL_DISPATCH_X = 16;
FB_CONSTANT uint CULL_DISPATCH_Y = 16;
FB_CONSTANT uint CULL_DISPATCH_Z = 1;
